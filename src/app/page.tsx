...
const FEATURES = [
  ...
  },
  {
    icon: Smile,
    title: 'Stickers & GIFs',
    description: 'Hundreds of stickers and animated GIFs organized by category to express yourself.',
    color: 'from-pink-500 to-rose-600',
  },
  {
    icon: ClipboardList,
    title: 'Smart Clipboard',
    description: 'Clipboard manager that saves your copied text for quick access and reuse.',
    color: 'from-violet-500 to-purple-600',
  },
  {
    icon: Zap,
    title: 'Fast & Smooth',
    description: 'Optimized for speed with smooth animations and instant key response.',
    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <header className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute top-1/3 left-1/4 w-40 h-40 bg-gradient-to-br from-pink-400/10 to-rose-400/10 rounded-full blur-2xl" />
        </div>
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
          ...
          <nav className="flex items-center justify-between mb-8 sm:mb-16">
            <div className="flex items-center gap-2">
              <img src="/keyboard-icon.png" alt="KeyFlow" className="w-9 h-9 rounded-xl shadow-lg" />
              <span className="text-lg font-bold tracking-tight">KeyFlow</span>
            </div>
            <div className="flex items-center gap-2">
              <Button
                variant="ghost"
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              >
                ...
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight leading-[1.1] mb-4">
                  Type in
                  <span className="bg-gradient-to-r from-emerald-500 to-teal-600 bg-clip-text text-transparent"> English </span>
                  &
                  <span className="bg-gradient-to-r from-amber-500 to-orange-600 bg-clip-text text-transparent"> Amharic </span>
                  with AI
                </h1>
                <p className="text-base sm:text-lg text-muted-foreground max-w-xl mx-auto lg:mx-0 mb-6 leading-relaxed">
                  ...
                  Featuring AI translation, stickers, GIFs, clipboard manager, 
                  and the full Ge&apos;ez script with all vowel forms.
                </p>
            ...
            >
              <div className="relative">
                ...
                <div className="relative w-[300px] sm:w-[340px] bg-gradient-to-b from-gray-800 to-gray-900 rounded-[2.5rem] p-2 shadow-2xl shadow-black/40">
                  ...
                  {/* Screen */}
                  <div className="relative bg-background rounded-[2rem] overflow-hidden" style={{ height: '520px' }}>
                    {/* Status bar */}
          ...
          >
            <div className="max-w-2xl mx-auto px-4 py-8">
              <div className="text-center mb-6">
                ...
                <p className="text-sm text-muted-foreground">Try the keyboard right here in your browser</p>
              </div>
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              >
                <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                  Full
                  <span className="bg-gradient-to-r from-emerald-500 to-teal-600 bg-clip-text text-transparent"> Ge&apos;ez Script</span>
                </h2>
                <p className="text-base text-muted-foreground mb-6 leading-relaxed">
                  Complete Amharic keyboard with all 33 base consonants and their 7 vowel forms. 
                  Long-press any consonant to see all vowel variations and pick the one you need.
                </p>
                <div className="space-y-3">
                  {[
                    '33 base consonants (ሀ-ፐ)',
                    '7 vowel forms per consonant',
                    'Long-press for vowel selection',
                    'Full Ge\'ez punctuation support',
                  ].map((item, i) => (
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 py-12 sm:py-20">
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
          ...
          >
            <h2 className="text-3xl sm:text-4xl font-bold mb-4">
              AI-Powered
              <span className="bg-gradient-to-r from-amber-500 to-orange-600 bg-clip-text text-transparent"> Translation</span>
            </h2>
            <p className="text-base text-muted-foreground mb-6 leading-relaxed">
              Translate any word or phrase between English and Amharic instantly. 
              Our AI understands context, idioms, and nuance to give you the most accurate translations.
            </p>
            <div className="space-y-3">
              {[
                'Context-aware translations',
                'Supports idioms and expressions',
                'Instant results with AI',
                'Use translations directly in your text',
              ].map((item, i) => (
                <div key={i} className="flex items-center gap-2">
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
          ...
          >
            ...
            <p className="text-base text-muted-foreground mb-8 max-w-lg mx-auto">
              Join thousands of bilingual users who type faster and translate smarter with KeyFlow.
            </p>
            <Button
              size="lg"
              onClick={() => setShowDemo(true)}
      ...
      <footer className="mt-auto border-t border-border/30 bg-muted/20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-6">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2">
              <img src="/keyboard-icon.png" alt="KeyFlow" className="w-7 h-7 rounded-lg" />
              <span className="text-sm font-semibold">KeyFlow</span>
              <span className="text-xs text-muted-foreground">• Bilingual Keyboard</span>
            </div>
